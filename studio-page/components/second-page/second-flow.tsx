...
export const SecondFlow = () => {
	...
	return (
		<header className="w-screen xl:h-[1024px] bg-[url('/first-flow/bg.gif')] bg-scroll sm:bg-cover ">
			<div className='flex flex-col items-center mx-[120px] lg:pb-10'>
				<div className='flex flex-col md:flex-row  items-center md:items-start lg:items-center md:space-x-[120px] xl:space-x-[340px] pt-[30px]'>
					...
					<div className='flex flex-col sm:flex-row md:flex-col lg:flex-row mt-[50px] sm:mt-8 md:mt-0 sm:space-x-12 md:space-x-0 md:space-y-3 lg:space-y-0 lg:space-x-5'>
				...
				<div className='flex flex-col lg:flex-row mt-10 sm:mt-8 xl:mt-[30px]'>
					...
					<div className='flex flex-col sm:flex-row lg:flex-col ml-0 lg:ml-4 mt-[30px] sm:mt-8 lg:mt-0 items-center sm:space-x-[28px] lg:space-x-0 sm:pb-10 lg:pb-0'>
						...
						<div className='flex flex-col pb-10 sm:pb-0'>
							<button className="flex flex-col w-[272px] md:w-[336px] lg:w-[360px] xl:w-[436px] h-[200px] xl:h-[240px] rounded-[24px] bg-[url('/second-flow/mayhem(1).gif')] bg-cover bg-center mt-6 sm:mt-0 lg:mt-6 justify-center text-center" onClick={() => setMM(o => !o)}>
							</button>
