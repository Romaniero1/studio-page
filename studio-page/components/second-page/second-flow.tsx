					...
					<div>
						<div className='w-[740px] h-[420px] rounded-[24px}'>
							...
							<Popup open={open} closeOnDocumentClick onClose={closeModal}>
								<div className="flex flex-col mx-auto w-[95%] h-[90vh] bg-purple rounded-[24px] bg-transparent-30 ">
									<a className="flex justify-end p-2 pr-4 text-base text-white" onClick={closeModal}>
										&times;
									</a>
						...
						<div className='grid grid-cols-2 w-[740px] h-[340px] rounded-[24px] bg-purple mt-6 p-6 gap-6 bg-opacity-60'>
							<div className="flex w-[334px] h-[134px] rounded-[24px] border-[1px] hover:bg-[url('/second-flow/bg-card/tv_onepager.png')] hover:bg-cover">
								...
								<Popup open={openTCop} closeOnDocumentClick onClose={closeTC}>
									<div>
										<a className="flex justify-end p-2 pr-4 text-base text-white" onClick={closeTC}>
											&times;
										</a>
										<PrismaZoom>
